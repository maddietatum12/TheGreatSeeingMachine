// DIAMOND HAPPINESS RESULT _________________________
...
function draw() {
  ...
  text(
    "It is time for a new direction. The path is closing behind you. Pack lightly… only of what is serving you. Your hands must be empty to accept what is to come. In seven days, the first clue will arrive.",
